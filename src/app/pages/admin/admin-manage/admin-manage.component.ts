...
export class AdminManageComponent implements OnInit {
  ...
  exams = [
    ...
    },
    {
      ...
      title: 'PHP',
      description:
        'PHP (Hypertext Preprocessor) is a server-side scripting language, and a powerful tool for making dynamic and interactive Web pages.',
      questionsCount: 15,
      category: 'backend',
    },
    {
      ...
      title: 'Java',
      description:
        'Java is a computer programming language. It is the most popular programming language in the world.',
      questionsCount: 15,
      category: 'backend',
    },
    {
